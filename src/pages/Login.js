    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-indigo-100 via-white to-indigo-200 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        {[...Array(18)].map((_, i) => (
          <div
            key={i}
            className={`absolute animate-confetti${i % 3} w-2 h-2 rounded-full`}
            style={{
      ...
      <div className="absolute left-1/2 top-12 -translate-x-1/2 flex flex-col items-center z-20 w-full max-w-2xl">
        <div className="flex items-center gap-4 animate-fade-in">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-indigo-700 drop-shadow-lg tracking-tight">
            Welcome to <span className="text-blue-500">FinTrack</span>
          </h1>
          <svg width="48" height="48" viewBox="0 0 48 48" fill="none">
            <rect
              x="0"
              ...
              fillOpacity="0.18"
            />
            <rect x="10" y="28" width="6" height="12" rx="2" fill="#6366f1" />
            <rect x="18" y="20" width="6" height="20" rx="2" fill="#38bdf8" />
            <rect x="26" y="12" width="6" height="28" rx="2" fill="#22d3ee" />
          </svg>
        </div>
        <div className="mt-2 text-indigo-400 text-lg md:text-2xl max-w-2xl text-center animate-fade-in delay-200">
          Track, save, and grow your money with confidence.
        </div>
        <div className="flex gap-4 mt-4 animate-fade-in delay-400">
          <span className="inline-block bg-green-100 text-green-700 px-4 py-1 rounded-full font-semibold shadow animate-bounce-badge">
            100% Secure
          </span>
          <span className="inline-block bg-blue-100 text-blue-700 px-4 py-1 rounded-full font-semibold shadow animate-glow">
            24/7 Support
          </span>
          <span className="inline-block bg-yellow-100 text-yellow-700 px-4 py-1 rounded-full font-semibold shadow animate-bounce-badge">
            Easy Registration
          </span>
        </div>
      </div>
      ...
      <div className="fixed left-10 bottom-36 z-30 animate-float-slow pointer-events-none">
        <span className="inline-flex items-center gap-1 bg-white/90 shadow px-4 py-2 rounded-full text-yellow-700 font-semibold text-base animate-glow border border-yellow-100">
          <svg width="20" height="20" viewBox="0 0 18 18" fill="none">
            ...
            <text x="50%" y="62%" textAnchor="middle" fontSize="13" fill="#fff">
              🔒
            </text>
          </svg>
          Privacy Guarantee
      ...
      <div className="absolute left-1/2 top-[38%] -translate-x-1/2 z-10 w-full max-w-4xl flex flex-wrap justify-between items-center pointer-events-none">
        ...
        <div className="animate-float-slow pointer-events-auto mr-[-180px] mb-[-60px]">
          <span className="inline-flex items-center gap-1 bg-white/80 shadow px-3 py-1 rounded-full text-blue-700 font-semibold text-sm mb-2 animate-glow">
            <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
              <circle cx="9" cy="9" r="9" fill="#38bdf8" />
              <text
                x="50%"
                y="62%"
                textAnchor="middle"
...
function RegisterFormInline({ onBackToLogin }) {
  ...
  return (
    ...
    >
      <div className="mb-2">
        <h2 className="text-3xl font-bold text-center text-indigo-700 mb-1 tracking-tight">
          Create Account
        </h2>
      ...
      <button
        ...
        className="bg-blue-700 hover:bg-blue-800 transition-colors rounded-xl shadow text-white text-base p-2 mt-1 font-semibold w-full"
      >
        Back to Login
      </button>
    </form>
